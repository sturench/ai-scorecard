...
model: sonnet
color: blue
tools: Glob, Grep, LS, Read, Edit, Write, TodoWrite, Bash, mcp__task-master-ai__get_task, mcp__task-master-ai__set_task_status, mcp__task-master-ai__update_subtask, mcp__task-master-ai__validate_dependencies, mcp__task-master-ai__add_subtask
---
